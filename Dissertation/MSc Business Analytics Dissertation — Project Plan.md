...
**Primary topic:** Topic 3 — _Identifying Feature Drift using Variable Importance and MCR_**Backup topic:** Topic 6 — _Evaluating Customer Segmentation via Consumer Stability_**Final submission:** 3pm Thursday 3 September 2026 (Turnitin)
...
| Introduction (+ Research Questions)       | 500–1,000    | Topic, focus, objectives, rationale                               |
| Literature Review                         | 2,500–4,000  | Synthesised argument leading to your Research Questions           |
...
| Discussion                                | 1,500–3,000  | What it means vs Research Questions, literature, and business use |
...
- [x] **Feasibility spike:** train a Random Forest on one synthetic dataset, compute SHAP, eyeball whether importance shifts near the known drift point. This de-risks the whole project before you commit.
- [x] Skim 8–10 papers from §2; draft the Research Questions.
- [x] **First supervision meeting:** refine objectives into a “do-able” project.
- [x] If a secure N/LAB dataset is ever needed, sign the **N/LAB Data Sharing Agreement** (likely not needed for open driftDatasets — confirm).
- [x] **Submit Dissertation Proposal Form via Moodle by 3pm Mon 22 June.**
- [x] **Complete Supervision Record Form 1.**

### Phase 1 — Late June → early July · Literature review & foundations

- [ ] Write the **literature review chapter** (your “story” toward the Research Questions).
...
- [ ] Write **Results** then **Discussion** (tie findings back to Research Questions, literature, and a business framing — e.g. retraining triggers / model-monitoring cost).
...
[https://app.notion.com/p/shreyuu/MSc-Business-Analytics-Dissertation-Project-Plan-37a8e3a22d9380f0919cc538a8a77232?source=copy_link](https://app.notion.com/p/shreyuu/MSc-Business-Analytics-Dissertation-Project-Plan-37a8e3a22d9380f0919cc538a8a77232)
